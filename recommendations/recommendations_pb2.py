...
if _descriptor._USE_C_DESCRIPTORS == False:
    ...
    _RECOMMENDATIONRESPONSE._serialized_end = 230
    _RECOMMENDATIONS._serialized_start = 297
    _RECOMMENDATIONS._serialized_end = 376
